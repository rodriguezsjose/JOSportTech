 ...
 * Use the {@link ReservasActivasFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ReservasActivasFragment extends Fragment {
    ...
    public ReservasActivasFragment() {
     ...
     * @return A new instance of fragment ReservasActivasFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ReservasActivasFragment newInstance(String param1, String param2) {
        ReservasActivasFragment fragment = new ReservasActivasFragment();
    ...
    private void asignarReferencias(){
        ...
        btnNuevo.setOnClickListener(view -> {
            Intent intent = new Intent(globalContext, ReservaActivity.class);
